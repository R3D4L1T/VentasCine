...
public final class AdminAccountPanel extends javax.swing.JPanel {
    ...
    public void recolectUser(String userName){
        ...
        adminis = dao.getAdmin(userName);
        btnProfile.setText(adminis.getNombre());
        txtFullname.setText(adminis.getNombre());
        txtUsername.setText(adminis.getApellidos());
        txtEmail.setText(adminis.getNumIdCard());
        txtRol.setText(adminis.getRol());
    ...
    private void initComponents() {
        ...
        btnProfile.setText("admin admin");
        ...
        lblUsernameM.setText("last name");
        ...
        lblEmailM.setText("number IDCard");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        txtFullnameM.setText(adminis.getNombre());
        txtUsernameM.setText(adminis.getApellidos());
        txtEmailM.setText(adminis.getNumIdCard());
    ...
    private void btnModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyActionPerformed
        ...
        String fullname = txtFullnameM.getText();
        ...
        if (opcion == JOptionPane.YES_OPTION) {
            ...
            DAOAdministrador dao =  new DAOAdministradorImpl();
            adminis.setNombre(fullname);
            adminis.setApellidos(user);
            adminis.setNumIdCard(email);
            dao.modifyData(adminis);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (opcion == JOptionPane.YES_OPTION) {
            DAOAdministrador daao =  new DAOAdministradorImpl();
            daao.remove(adminis.getNombre());
    ...
    private void btnPassUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPassUpdateActionPerformed
        ...
        if (opcion == JOptionPane.YES_OPTION) {
            ...
            DAOAdministrador daaoo =  new DAOAdministradorImpl();
            boolean verify = daaoo.loginVerify(adminis.getNombre(),passActual, adminis.getRol());
            
            if(verify){
                if(newPass.equals(ConfirmPass)){
                    adminis.setPassword(newPass); 
                    daaoo.modifyData(adminis);
                    ...
                    JOptionPane.showMessageDialog(null, "la confirmacion es incorrecta");
                }
            }
            else{
                JOptionPane.showMessageDialog(null, "credencial incorrecta");
            }
